            ...
            {mySubmissions.map(sub => (
              <div key={sub.id} style={{ 
                ...
                <div style={{ display: 'flex', gap: '0.5rem' }}>
                  ...
                  >
                    {editingPostId === sub.id ? <span><CancelIcon /><span className="btn-text-desktop"> Cancel</span></span> : <span><EditIcon /><span className="btn-text-desktop"> Edit</span></span>}
                  </button>
                  <button 
                    ...
                    style={{ padding: '0.4rem 0.8rem', fontSize: '0.8rem', margin: 0 }}
                  >
                    <span><TrashIcon /><span className="btn-text-desktop"> Remove</span></span>
                  </button>
                </div>
                  ...
                  <div style={{ display: 'flex', gap: '0.5rem' }}>
                    {post.author_id === session.user.id && (
                      <button 
                        ...
                        style={{ padding: '0.4rem 0.8rem', fontSize: '0.8rem', margin: 0 }}
                      >
                        {editingPostId === post.id ? <span><CancelIcon /><span className="btn-text-desktop"> Cancel</span></span> : <span><EditIcon /><span className="btn-text-desktop"> Edit</span></span>}
                      </button>
                    )}
                    <button 
                      ...
                      style={{ padding: '0.4rem 0.8rem', fontSize: '0.8rem', margin: 0 }}
                    >
                      <span><TrashIcon /><span className="btn-text-desktop"> Delete</span></span>
                    </button>
                    {isCommunityAdmin && (
                      <button 
