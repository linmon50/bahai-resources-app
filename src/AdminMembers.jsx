                        ...
                        <div key={post.id} className="glass-panel" style={{ 
                            ...
                            {post.link_url && (
                                <div style={{ marginBottom: '1.5rem', fontSize: '0.85rem', color: '#97f7e9' }}>
                                    ...
                                    <a href={normalizeUrl(post.link_url)} target={getLinkTarget(post.link_url)} rel={isInternalLink(post.link_url) ? undefined : "noopener noreferrer"} style={{ color: 'inherit' }}>{post.link_url}</a>
                                </div>
                            )}
