...
async function run() {
    ...
    try {
        ...
        console.log("Dropping directory_view...");
        await client.query("DROP VIEW IF EXISTS public.directory_view;");

        console.log("Re-creating directory_view WITH (security_invoker=true)...");
        await client.query(`
        ...
        `);
        console.log("View re-created successfully!");
